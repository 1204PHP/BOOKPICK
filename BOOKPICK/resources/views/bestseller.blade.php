	...
	<div class="best-main-box">
		<div class="best-container">
			<ul class="best-text-box">
				...
				<img src="{{ asset('img/p-btn.png')}}" class="carousel-prev" onclick="prevbtn()" alt="...">
				<img src="{{ asset('img/n-btn.png')}}" class="carousel-next"onclick="nextbtn()" alt="...">
		</div>
	</div>
	<div class="best-main-box2">
